<template>
  <div class="container-fluid">
    <div class="row">
      <h2 class="col-12">
        Сведения из реестра членов Ассоциации в отношении действующих членов Ассоциации
      </h2>
    </div>
    <div class="row">
      <table class="table">
...
export default {
  ...
  async asyncData({$axios}) {
    let value = 'ГлавПроект - реестр действующих.xlsx'
  ...
  meta: [
    {description: 'СРО "Главпроект" - реестр действующих членов организации'}
  ],
  props: {
    item: {
      type: Object,
